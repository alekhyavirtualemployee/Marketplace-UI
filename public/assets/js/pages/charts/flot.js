...
$(function() {
    ...
    var data = [{ data: d1, label: "Pressure", color: "#a890d3" }];

    var markings = [
        { color: "#2d333c", yaxis: { from: 1 } },
        { color: "#2d333c", yaxis: { to: -1 } },
        { color: "#a890d3", lineWidth: 1, xaxis: { from: 2, to: 2 } },
        { color: "#a890d3", lineWidth: 1, xaxis: { from: 8, to: 8 } }
    ];
